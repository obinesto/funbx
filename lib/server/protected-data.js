...
async function hydrateInteractionVideos(rows, dateField) {
...
export async function getServerWatchHistory() {
  ...
  return hydrateInteractionVideos(data || [], "watchedAt");
}
...
export async function getServerLikedVideos() {
  ...
  return hydrateInteractionVideos(data || [], "likedAt");
}
...
export async function getServerSavedVideos() {
  ...
  return hydrateInteractionVideos(data || [], "savedAt");
}
